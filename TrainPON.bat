...
cls
echo --- Tutorial ---
echo 1) Waehle Vokabel-/Formentraining
echo 2) Gib Dateikuerzel (ohne .txt) ein
echo 3) Leerzeichen + Enter startet die Frage
echo 4) Antworten im Stil des Buches (z.B. 1P SG AKK)
echo 5) Ein Streak-Punkt pro Tag moeglich
echo 6) Wird ein Tag ausgelassen, startet der Streak bei 0
exit /b
...
if exist %STATS% (
    ...
    echo Noch keine Statistikdaten vorhanden.
)
exit /b
...
:UNINSTALL
cls
echo TrainPON wirklich vollstaendig entfernen? (J/N)
choice /c JN /n /m "Bestaetigen: "
